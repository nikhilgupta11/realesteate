...
<div class="container">
    <div class=" content-wrapper">
        ...
        @endif
        <div class="container">
        <form class="form bg-white p-4 rounded shadow" method="POST" enctype="multipart/form-data" action="{{ route('property.store') }}" name="formPrevent">
            @csrf
            <!-- model value  -->
            ...
            <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select class="form-control " name="generalAmenities" id="generalAmenities" multiple>
                ...
                <br> <button type="submit" class="btn btn-success float-right text-white">Submit</button>
                </div>
            </div>
        </form>
        </div>
