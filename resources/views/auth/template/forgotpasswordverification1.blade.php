                ...
                <div class="row w-100 m-0">
                    <div class="col-lg-4 col-md-6 col-sm-8 login-container  mx-auto">
                        ...
                        <div class="auto-form-wrapper">
                            @if($logo)
                            <a href="{{url('/')}}">
                                <img src="{{ asset('assets/images/generalsetting/'.$logo) }}" alt="" width="150" height="40" class="logocuston"></a>
                            @else
                            <a href="{{url('/')}}">
                                <img src="{{ asset('assets/images/logo.png') }}" alt="" width="150" height="40" class="logocuston"></a>
                            @endif

                            <h5 class="logocuston">Reset Password</h5>
                            <form method="POST" action="{{ route('resetpassword1', $token) }}">
                                @csrf
