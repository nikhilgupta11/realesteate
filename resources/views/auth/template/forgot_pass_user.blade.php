            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('resetpassword2',$token) }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input-box d-flex flex-row align-items-center mb-4">
                                        <i class="fa fa-lock me-3" aria-hidden="true"></i>
                                        <div class="form-outline flex-fill mb-0">
                                            <input id="password" type="password" placeholder="{{ __('Password') }}" class="form-control @error('password') is-invalid @enderror" name="confirmpassword" required autocomplete="current-password">
                                        </div>
                                    </div>
                                    <!-- <label for="password" class="col-form-label text-md-end">{{ __('Password') }}<span class="required">*</span></label> -->
