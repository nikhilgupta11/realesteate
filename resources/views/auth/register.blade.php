                        ...
                        <form method="POST" action="{{ route('UserRegistered') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <!-- <label for="password-confirm" class="col-form-label text-md-end"><span class="required">*</span></label> -->


                                </div>
                            </div>
                            <!-- <div class="form-check">
                                <input class="form-check-input" type="hidden" value="0" id="flexCheckChecked" name="type">
                                <input class="form-check-input" type="checkbox" value="2" id="flexCheckChecked" name="type">
                                <label class="form-check-label" for="flexCheckChecked">
                                    If you want to register as Agent
                                </label>
                            </div> -->
                            ...
                            <div class="row mb-0">
                                <div class="col-md-12 offset-md-4">
                                    <p class="register">Already have an account? 
                                        <a class="bold" href="{{ route('userLogin') }}">
                                        Login
                                        </a>
                                    </p>
                                </div>
