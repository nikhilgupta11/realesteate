                    ...
                    <div class="mx-auto">
                        ...
                        <div class="login-container auto-form-wrapper">
                            <div class="card">
                                ...
                                @endif
                                <div class="card-header logocuston mx-0"><p class="h2">Agent Login</p></div><br>
                                <div class="card-body">
                                    <form method="POST" action="{{ route('agentLoggedin') }}">
                                        @csrf
                                        ...
                                        <div class="form-group d-flex justify-content-between">
                                            ...
                                            <a href="{{ route('admin_forgot_screen1') }}" class=" text-small forgot-password">
                                                Forgot Password
                                            </a>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group d-flex justify-content-center">
                                            <p class="text-small text-black">Don't have account? 
                                                <a href="{{route('agentRegister')}}" class="text-small forgot-password">
                                                    Register
                                                </a>
                                            </p>
                                        </div>
