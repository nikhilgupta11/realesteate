...
<div class="content-wrapper">
    ...
    @endif 
    <form method="POST" action="{{ route('PropertyCreate') }}" enctype="multipart/form-data" name="formPrevent" autocomplete="off">
        @csrf
        <div class="row mt-2">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="contactNumber" class="form-control @error('contactNumber') is-invalid @enderror" name="contactNumber" id="contactNumber" />
                @error('contactNumber')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-md-3 form-group">
                <label for="reason">Assign User <span class="required">*</span></label>
                <select class="form-control @error('Utype') is-invalid @enderror" name="userid" id="userid">
            ...
            <div class="col-md-3 form-group">
                <label for="reason">Assign Agent <span class="required">*</span></label>
                <select class="form-control @error('Utype') is-invalid @enderror" name="agentid" id="agentid">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="text" class="form-control @error('totalPrice') is-invalid @enderror" name="totalPrice" id="totalPrice" />
                @error('totalPrice')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
