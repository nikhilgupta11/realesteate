                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('states.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('states.update', '')}}" + "/" + full.id;
                        var show = "{{route('states.show','')}}" + "/" + full.id;
                        var edit_url = "{{route('states.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/states/" + full.id + "/edit";
                        return `
