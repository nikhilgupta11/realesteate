                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('portals.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('portals.update', '')}}" + "/" + full.id;
                        var show = "{{route('portals.show','')}}" + "/" + full.id;
                        var edit_url = "{{route('portals.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/portals/" + full.id + "/edit";
                        return `
