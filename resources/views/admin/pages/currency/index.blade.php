    ...
    <div class="content-header">
        <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('currencies.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="currency_symbol">
                <strong>Current Curency :</strong> {{ $defaultValue->country_name }}
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('currencies.update', '')}}" + "/" + full.id;
                        var edit_url = "{{route('currencies.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/currencies/" + full.id + "/edit";
                        return `
        ...
        $('#savebutton').on('click', function() {
            $.ajax({
                type: "POST",
                url: "{{ url('/admin/delete-currencies') }}",
                data: {
                    id: nikh
                },
                dataType: 'json',
