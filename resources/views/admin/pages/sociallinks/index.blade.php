                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('sociallink.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('sociallink.update', '')}}" + "/" + full.id;
                        var edit_url = "{{route('sociallink.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/sociallink/" + full.id + "/edit";
                        return `
        ...
        $('#savebutton').on('click', function() {
            $.ajax({
                type: "POST",
                url: "{{ url('/admin/delete-sociallink') }}",
                data: {
                    id: nikh
                },
                dataType: 'json',
