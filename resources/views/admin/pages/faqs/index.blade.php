                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('faqs.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        $('#datatable-crud').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        if (type === 'display') {
                            data = typeof data === 'string' && data.length > 80 ? data.substring(0, 40) + '...' : data;
                        }
                        return data;
                    },
                },
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('faqs.update', '')}}" + "/" + full.id;
                        var show = "{{route('faqs.show','')}}" + "/" + full.id;
                        var edit_url = "{{route('faqs.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/faqs/" + full.id + "/edit";
                        return `
