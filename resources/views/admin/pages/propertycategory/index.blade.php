                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('propertyCategorycreate') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <table class="table table-bordered" id="datatable-crud">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('propertyCategorydelete', ['id' => $data->id]) }}"><button class="btn btn-danger"><i class="fa fa-trash"><i></button></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
