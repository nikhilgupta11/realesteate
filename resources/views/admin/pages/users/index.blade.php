                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('users.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('users.update', '')}}" + "/" + full.id;
                        var show = "{{route('users.show','')}}" + "/" + full.id;
                        var edit_url = "{{route('users.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/users/" + full.id + "/edit";
