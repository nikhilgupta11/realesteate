...
<div class="content-wrapper">
    ...
    @endif
    <form method="POST" enctype="multipart/form-data" action="{{ route('propertytypes.store') }}" name="formPrevent">
        @csrf
        <div class="row mt-2">
        ...
        <div class="row mt-2">
            <div class="col-md-12 form-group">
                <label for="descriptiom">Description <span class="required">*</span></label>
                <textarea id="content" name="description" class="form-control @error('description') is-invalid @enderror" ></textarea>
                @error('description')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
