                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('cities.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('cities.update', '')}}" + "/" + full.id;
                        var show = "{{route('cities.show','')}}" + "/" + full.id;
                        var edit_url = "{{route('cities.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/cities/" + full.id + "/edit";
                        return `
