                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('news.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('news.update', '')}}" + "/" + full.id;
                        var show = "{{route('news.show','')}}" + "/" + full.id;
                        var edit_url = "{{route('news.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/news/" + full.id + "/edit";
                        return `
                        <a href="${show}"class="btn btn-success">
                           <i class='fa fa-eye'></i>
                        </a>
                        <a href="${edit_url1}" class="btn btn-primary">
