...
<div class="content-wrapper">
    ...
    @endif
    <form action="{{ route('countries.store') }}" method="POST" enctype="multipart/form-data" name="formPrevent">
        @csrf
        <div class="row mt-2">
            <div class="col-md-4 form-group">
                <label for="countryname">Country Name <span class="required">*</span></label>
                <input type="text" name="countryname" class="form-control @error('countryname') is-invalid @enderror" placeholder="Country Name"  />
                @error('countryname')
