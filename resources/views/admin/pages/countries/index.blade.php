                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">
                                <span></span> <a href="{{ route('countries.create') }}" class="btn btn-success btn-lg float-right">Create</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        var url = "{{route('countries.update', '')}}" + "/" + full.id;
                        var show = "{{route('countries.show','')}}" + "/" + full.id;
                        var edit_url = "{{route('countries.edit', '')}}";
                        var edit_url1 = "{{ env('APP_URL') }}"+ "/admin/countries/" + full.id + "/edit";
                        return `
